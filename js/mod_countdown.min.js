	...
	0 < a.leftTime && window.setInterval(function() {
		...
		if (0 < a.leftTime) {
			...
			case 1:
				...
				break;
			case 2:
				a.target.find(a.el_hour).children().eq(0).html(b[0]), a.target.find(a.el_hour).children().eq(1).html(b[1])
			}
			9 >= c && (c = "0" + c);
			c = c.toString();
			...
			case 1:
				...
				break;
			case 2:
				a.target.find(a.el_min).children().eq(0).html(c[0]), a.target.find(a.el_min).children().eq(1).html(c[1])
			}
			9 >= d && (d = "0" + d);
			d = d.toString();
			...
			case 1:
				...
				break;
			case 2:
				a.target.find(a.el_sec).children().eq(0).html(d[0]), a.target.find(a.el_sec).children().eq(1).html(d[1])
			}
		}
	}, 1E3 * a.speed)
};